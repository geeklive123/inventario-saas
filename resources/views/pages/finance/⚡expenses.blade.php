...
new #[Title('Gastos')] class extends Component
{
    ...
    public function openCreate(): void
    {
        ...
        $this->reset(['categoryId', 'branchId', 'paymentMethodId', 'amountBase', 'concept', 'reference', 'notes']);
