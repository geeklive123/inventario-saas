...
test('inventory screens explain costs with friendly labels and localized money', function () {
    ...
    Livewire::actingAs($context['user'])
        ...
        ->assertSee('Costo promedio actual')
        ->assertSee('Valor total en stock')
        ->assertSee('Último precio pagado')
        ->assertSee('Es el costo promedio por unidad considerando todas las compras registradas.')
        ->assertSee('Es cuánto vale actualmente todo el stock disponible de este insumo.')
        ->assertSee('Es el precio por unidad de la compra más reciente.')
